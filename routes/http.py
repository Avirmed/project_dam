...
@http_bp.route("/list", methods=["GET", "POST"])
@login_required
def list():
    ...
    jsonResult = Http.list(requestData)
    ...
    jsonResult["column"] = [
        ...
        {"title": statictext.HttpField["ID"], "field": "ID", "visible": False},
        {
            "title": statictext.HttpField["StationID"],
            "field": "SiteName",
            "formatter": "textarea",
            "headerHozAlign": "center",
            "vertAlign": "middle",
        ...
        {
            "title": statictext.HttpField["URL"],
            "field": "URL",
            "formatter": "textarea",
            "headerHozAlign": "center",
            "vertAlign": "middle",
        ...
        {
            "title": statictext.HttpField["Status"],
            "field": "Status",
            "width": 100,
            "headerHozAlign": "center",
            "hozAlign": "center",
        ...
        {
            "title": statictext.HttpField["Remark"],
            "field": "Remark",
            "width": "20%",
            "formatter": "textarea",
            "headerHozAlign": "center",
...
@http_bp.route("/save", methods=["POST"])
...
def save():
    ...
    jsonResult = Http.save(requestData)

    return jsonify(jsonResult), jsonResult["Code"]


@http_bp.route("/delete", methods=["POST"])
@require_types(*EDITORS)
def delete():
    get_data = request.args.to_dict()
    post_data = (
    ...
    jsonResult = Http.delete(requestData)
