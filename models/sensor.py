...
class Sensor(db.Model):
    ...
    sort = [
        {"column": "SensorID", "field": "SensorID", "dir": "asc"},
        {"column": "SensorName", "field": "SensorName", "dir": "asc"},
    ]

    searchFields = ["SensorID", "SensorName"]
    ...
    def __repr__(self):
        return f"<Sensor {self.ID}:{self.SensorID}-{self.SensorName}>"
