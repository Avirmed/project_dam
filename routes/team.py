...
def getByPost():
    ...
    object_data = Team.getData(objID)
...
def list():
    ...
    jsonResult = Team.list(requestData)
    ...
    jsonResult["column"] = [
        ...
        {"title": statictext.TeamField["TeamID"], "field": "TeamID", "visible": False},
        {
            "title": statictext.TeamField["ImageSource"],
            "field": "Image",
            "width": 70,
            "headerHozAlign": "center",
            "hozAlign": "center",
        ...
        {
            "title": statictext.TeamField["TeamName"],
            "field": "TeamName",
            "formatter": "textarea",
            "headerHozAlign": "center",
            "vertAlign": "middle",
        ...
        {
            "title": statictext.TeamField["Status"],
            "field": "Status",
            "width": 100,
            "headerHozAlign": "center",
            "hozAlign": "center",
        ...
        {
            "title": statictext.TeamField["Remark"],
            "field": "Remark",
            "width": "20%",
            "formatter": "textarea",
            "headerHozAlign": "center",
...
def save():
    ...
    jsonResult = Team.save(requestData)
...
def delete():
    ...
    jsonResult = Team.delete(requestData)
...
def file_upload():
    ...
    if lastPart:
        object = Team.query.get(contentid)
        if not object:
            try:
        ...
        dest_path = os.path.join(Team.drfFilePath, filename)
...
def imgrotate():
    ...
    object_id = requestData.get("TeamID")
    ...
    try:
        object = Team.query.get(object_id)
