	...
	class DataTree extends Module{
		...
		initializeRow(row){
			...
			if(!children && row.modules.dataTree && row.modules.dataTree.branchEl){
				if (row.modules.dataTree.branchEl.parentNode && 'removeChild' in row.modules.dataTree.branchEl.parentNode) {
					row.modules.dataTree.branchEl.parentNode.removeChild(row.modules.dataTree.branchEl);
				}
			}

			if(!children && row.modules.dataTree && row.modules.dataTree.controlEl){
				if (row.modules.dataTree.controlEl.parentNode && 'removeChild' in row.modules.dataTree.controlEl.parentNode) {
